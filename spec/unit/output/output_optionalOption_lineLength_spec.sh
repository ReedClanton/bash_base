			...
			Describe "Input special character:" outputOutputOptionalOptionLineLength:inputSpecialCharacter
				Describe "-l:" outputOutputOptionalOptionLineLengthInputSpecialCharacter:l
					It "Space before" outputOutputOptionalOptionLineLengthInputSpecialCharacterL:spaceBefore
						When run source $output -m=msg1msg2 -l="          8"
					...
					It "Space before and after" outputOutputOptionalOptionLineLengthInputSpecialCharacterL:spaceBeforeAndAfter
						When run source $output -m=msg1msg2 -l="          7              "
						The stderr should not be present
					...
					It "Space after" outputOutputOptionalOptionLineLengthInputSpecialCharacterL:spaceAfter
						When run source $output -m=msg1msg2 -l="9              "
						The stderr should not be present
						The lines of stdout should equal 1
						The stdout line 1 should equal "msg1msg2"
						The status should be success
				...
				Describe "--line-length:" outputOutputOptionalOptionLineLengthInputSpecialCharacter:lineLength
					It "Space before" outputOutputOptionalOptionLineLengthInputSpecialCharacterLineLength:spaceBefore
						When run source $output -m=msg1msg2 --line-length="          4"
						The stderr should not be present
						The lines of stdout should equal 2
					...
					It "Space before and after" outputOutputOptionalOptionLineLengthInputSpecialCharacterLineLength:spaceBeforeAndAfter
						When run source $output -m=msg1msg2 --line-length="          1              "
						The stderr should not be present
					...
					It "Space after" outputOutputOptionalOptionLineLengthInputSpecialCharacterLineLength:spaceAfter
						When run source $output -m=msg1msg2 --line-length="2              "
						The stderr should not be present
			...
			Describe "Bound:" outputOutputOptionalOptionLineLength:bound
				Describe "-l:" outputOutputOptionalOptionLineLengthBound:l
					...
					It "Above lower" outputOutputOptionalOptionLineLengthBoundL:aboveLower
						When run source $output -m=msg1msg2 -l=1
						The stderr should not be present
						The lines of stdout should equal 8
						The stdout line 1 should equal "m"
						The stdout line 2 should equal "s"
					...
					It "Far above lower" outputOutputOptionalOptionLineLengthBoundL:farAboveLower
						When run source $output -m="test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test " -l=1000
						The stderr should not be present
						The lines of stdout should equal 1
				...
				Describe "--line-length:" outputOutputOptionalOptionLineLengthBound:lineLength
					...
					It "Above lower" outputOutputOptionalOptionLineLengthBoundLineLength:aboveLower
						When run source $output -m=msg1msg2msg3msg4msg5msg6msg7msg8 --line-length=1
					...
					It "Far above lower" outputOutputOptionalOptionLineLengthBoundLineLength:farAboveLower
						When run source $output -m="test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test t" --line-length=10000
						The stderr should not be present
						The lines of stdout should equal 2
