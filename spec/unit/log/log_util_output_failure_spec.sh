...
Describe "Log:" log
	Describe "log():" log:log
		...
		Describe "Util:" logLog:util
			Describe "output() failure:" logLogUtil:output
				Describe "Non zero return code:" logLogUtilOutput:nonZeroReturnCode
					It "3" logLogUtilOutputNonZeroReturnCode:3
					...
					End
					It "140" logLogUtilOutputNonZeroReturnCode:140
						...
						The status should equal $MINOR_EXECUTION_FAILURE_RT
					End
					It "141" logLogUtilOutputNonZeroReturnCode:141
						...
						The status should equal $MINOR_EXECUTION_FAILURE_RT
					End
					It "142" logLogUtilOutputNonZeroReturnCode:142
						...
						The status should equal $MINOR_EXECUTION_FAILURE_RT
					End
					It "200" logLogUtilOutputNonZeroReturnCode:200
